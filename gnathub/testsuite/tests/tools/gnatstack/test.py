...
TEXT_IO = ["a-textio.ads", "a-textio.ads 566:14"]
S_IMGINT = ["s-imagei.ads", "s-imagei.ads 65:14"]
S_SECSTA = ["s-secsta.ads", "s-secsta.ads 314:9"]
F_ADB = ["f.adb", "f.adb 9:4"]
F_ADS = ["f.ads"]
SIMPLE_ADB = ["simple.adb", "simple.adb 19:4", "simple.adb 28:4",
              "simple.adb 10:4"]
SIMPLE_4_1 = ["simple.adb 4:1"]
B_SIMPLE_ADB = ["b__simple.adb", "b__simple.adb 216:18", "b__simple.adb 225:4"]
...
class TestGNATstackSupport(TestCase):
    ...
    def testDatabaseContent(self):
        ...
        self.assertTrue(parser.has_option(B_SIMPLE_ADB[2], ENTRY_POINT[0]),
                        "Entry point not found")
        self.assertTrue(parser.get(B_SIMPLE_ADB[2],
