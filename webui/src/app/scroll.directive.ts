...
export class AutoScrollDirective {
    ...
    @Input() public routerLink: any = null;
    @Input() public href: string = null;
    @Input() public smooth: boolean = false;
    ...
    protected doScroll(target: HTMLElement): void {
        AutoScrollDirective.setScrollTop(this.body, target);
        AutoScrollDirective.setScrollTop(this.document.documentElement, target);
        AutoScrollDirective.setScrollTop(this.document.body.parentNode, target);
    }
    ...
    private doSmoothScroll(target: HTMLElement): void {
        const startY = AutoScrollDirective.currentYPosition();
        const stopY = AutoScrollDirective.elmYPosition(target);
